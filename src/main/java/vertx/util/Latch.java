 ...
 */
public class Latch {
    private LatchAction onComplete;
    private int count;
     ...
     */
    public Latch(int count, LatchAction onComplete) {
     ...
     */
    public void reset(int count, LatchAction onComplete) {
        validateParams(count, onComplete);
    ...
    private void validateParams(int count, LatchAction onComplete) {
        if (count < 1) {
